...
<!-- <style>	@import url(https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0);</style>  -->
</head>
  ...
  <header>
      ...
      <div id="container">
        ...
        <!-- GNB -->
          ...
          <ul id = "gnb">
            <li><a href="javascript:fnBoardList();">고객센터</a>
              <ul>
                <li><a href="javascript:fnBoardList();">공지사항</a></li>
                <li><a href="javascript:fnBoardList();">자유 게시판</a></li>
                <li><a href="javascript:fnBoardList();">1:1 문의</a></li>
              </ul>
            </li>
          </ul>
				...
				<div id="lnb">
					<ul id="gnb">
						<li><img src="/resources/images/login.png" alt=""> 
							<ul>
								...
								<c:if test="${sessionScope.userid != null && sessionScope.userid eq 'master'}">
    ...
    <div id="section2">
      <div id="container">
        ...
        <img src="/resources/images/main_section2-1.png" />
          <!-- <img src="assets/images/main_section2-1.png"> -->
